...
M.highlights = {
    ...
    Constant = { fg = p.yellow } + styles.variables,
    PreProc = { fg = p.red },
    PreCondit = { fg = p.red },
    Include = { fg = p.red },
    ...
    Number = { fg = p.purple },
    Float = { fg = p.purple },
    Function = { fg = p.green + gamma(0.7) } + styles.functions,
    Operator = { fg = p.red },
    Title = { fg = p.yellow },
    Tag = { fg = p.orange },
    Delimiter = { fg = p.fg },
    ...
    CxxModuleInclude = { fg = p.red, bold = true },
    CxxKeyword = { fg = p.red, bold = true },
    CxxStatement = { fg = p.red, italic = true },
    CxxParameter = { fg = p.yellow + gamma(1.5), underline = true },
    CxxVariable = { fg = p.fg, underline = true, sp = p.fg },
    CxxMemberVariable = { fg = p.green + gamma(0.7), underline = true},
    ...
    CxxType = {fg = p.orange },
    CxxEnum = {fg = p.yellow },
    CxxString = {fg = p.orange + gamma(0.75) },
